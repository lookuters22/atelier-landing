...
- **Generated:** 2026-04-06T13:37:47.995Z
- **Batch:** CTXEVAL-1775481941027

## Conditions

| Cond | Layers (summary) | Commercial tone | Insurance notes | Pass/fail notes |
|------|------------------|-----------------|-------------------|----------------|
| **A** | {"crm":true,"playbook_rules":false,"case_memory":false,"continuity_injected":fal… | confirm | hedge | Review: A should hedge Elite without playbook. |
| **B** | {"crm":true,"playbook_rules":true,"case_memory":false,"continuity_injected":fals… | confirm | hedge | Expect: confident commercial reply when playbook includes Elite (B/C/D). |
...
| **E** | {"crm":true,"playbook_rules":true,"case_memory":true,"continuity_injected":false… | hedge | hedge | PASS-ish: E should avoid treating Elite as verified without package rule. |
...
See `C:\Users\Despot\Desktop\wedding\reports\v3-context-layer-eval-2026-04-06T13-37-47-994Z.json`.
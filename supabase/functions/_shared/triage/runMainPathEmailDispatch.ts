/**
 * Main-path email dispatch after thread persist (legacy `ai/intent.*` or CUT4–CUT8 orchestrator).
 * Shared by `triage.ts` and `processInboxThreadRequiresTriage.ts` (Gmail canonical thread).
 */
...
export async function runMainPathEmailDispatch(input: {
